		...
		<div class="all-products">
			<div class="product">
				...
				<div class="product-info">
					...
					<a class="product-btn" href="hospital/pacientes.php">pacientes</a>
				</div>
			</div>
			<div class="product">
				...
				<div class="product-info">
					...
					<a class="product-btn" href="hospital/urgencias.php">Ingresar</a>
				</div>
				...
				<div class="product-info">
					...
					<a class="product-btn" href="hospital/medicos.php">Ingresar</a>
				</div>
