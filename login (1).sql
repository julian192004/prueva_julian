...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-03-2024 a las 17:35:12
...
INSERT INTO `depar` (`id_depart`, `depart`) VALUES
(5, 'ANTIOQUIA'),
(8, 'ATLANTICO'),
(11, 'BOGOTÁ, D.C.'),
(13, 'BOLÍVAR'),
...
(1, 'Juan Guarnizo', 'gereatria', '3125678903'),
(2, 'Diego Duran ', 'Ginecologo', '3184562354'),
(3, 'Fernanda Diaz ', 'Anatomia patologica', '3126142234'),
(1111111111, 'Jorge', 'Liposubciones', '3123321321'),
(1111111112, 'junior', 'ginecologo', '3142145264'),
(1111111113, 'paulo', 'cirujano plastico', '64278193287'),
(1111111114, 'paulo', 'cirujano plastico', '64278193287'),
(1111111115, 'paulo', 'cirujano plastico', '64278193287');
...
INSERT INTO `pacientes` (`id`, `nombre`, `edad`, `genero`, `direccion`, `telefono`) VALUES
(2, 'guillermo', 24, 'Masculino', 'calle 36 con 4ta', '32435324321'),
(8765432, 'jijiji', 87, 'M', 'kajj', '352678'),
(67890987, 'jijiji', 87, 'M', 'kajj', '352678'),
(1105610405, 'JUAN', 19, 'M', 'versalles', 'casa 76'),
(1234567899, 'Diego', 87, 'M', 'calarca', '3213213231'),
(2147483647, 'jaajaja', 78, 'M', 'JAJA', '3183183182');
...
INSERT INTO `urgencias` (`id`, `id_paciente`, `id_medico`, `fecha`, `enfermedad`) VALUES
(1, 1, 3, '2024-03-20 13:09:29', 'Diarrea'),
(2, 1, 2, '2024-03-20 00:00:00', 'sifalea'),
(3, 4, 4, '2024-03-20 00:00:00', 'CIRUGIA DE CARA'),
(4, 4, 4, '2024-03-20 00:00:00', 'CIRUGIA DE CARA');
...
('11111111', 'JULIAN DAVID ARIAS', '$2y$10$opUOaBm8biZte1HJeumy7eAGe62IHJReF/N7J2zRGasiLc0mSc1xm', 'julian@gmail.com', 1, '', 'barrio gaitan', 2147483647),
...
--
ALTER TABLE `medicos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1111111116;
...
--
ALTER TABLE `transversal`
  MODIFY `id_transv` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
